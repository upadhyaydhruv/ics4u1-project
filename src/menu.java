...
public class menu{
    ...
    public void paint(Graphics2D thisFrame) {
        ...
        thisFrame.drawImage(startButton,startButtonRec.x,startButtonRec.y,startButtonRec.width,startButtonRec.height,null);
        thisFrame.drawImage(creditsButton,creditsButtonRec.x,creditsButtonRec.y,creditsButtonRec.width,creditsButtonRec.height,null);
    }
