...
public class Main extends JPanel {
    ...
    public static final boolean ENABLE_DEBUG_FEATURES = true; // DISABLE THIS BEFORE HANDING IN OR IF THERE IS TOO MUCH LAG, AS IT SHOWS HITBOXES AND DEBUG MESSAGES
